...
| `src/config.js` | `CONFIG` — all gameplay numbers, flags, colours, and **the bestiary**: `enemyTypes`, where a variant's sprite, colour filter, size, stats and ROLE (melee / ranged / summoner / healer) are defined |
